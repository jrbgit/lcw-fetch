...
class CoinDelta(BaseModel):
    ...
    day: Optional[float] = Field(None, description="Rate of change in the last 24 hours")
    week: Optional[float] = Field(None, description="Rate of change in the last 7 days")
    month: Optional[float] = Field(None, description="Rate of change in the last 30 days")
    quarter: Optional[float] = Field(None, description="Rate of change in the last 90 days")
    year: Optional[float] = Field(None, description="Rate of change in the last 365 days")
...
class Coin(BaseModel):
    ...
    categories: Optional[List[str]] = Field(default_factory=list, description="Coin categories")
    delta: Optional[CoinDelta] = Field(None, description="Rate of change data")
    
    # Historical data (for history endpoint)
    history: Optional[List[CoinHistory]] = Field(default_factory=list, description="Historical data points")
