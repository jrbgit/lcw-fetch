...
class TestLCWNetworkError:
    ...
    def test_network_error_creation(self):
        ...
        assert error.status_code is None  # Network errors typically don't have status codes
        assert isinstance(error, LCWAPIError)
...
class TestExceptionAttributes:
    ...
    def test_exception_attributes_custom_values(self):
        ...
        error = LCWAPIError("test message", status_code=418, response_data=response_data)
