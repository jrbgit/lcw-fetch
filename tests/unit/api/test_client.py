...
from src.lcw_fetcher.api.exceptions import (
    LCWAPIError, LCWRateLimitError, LCWAuthError, LCWNetworkError
)
...
class TestLCWClientCoinMethods:
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_coin_single_default_params(self, mock_make_request, mock_api_key, sample_coin_data):
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_coin_history_with_datetime(self, mock_make_request, mock_api_key, sample_coin_data):
        ...
        mock_make_request.assert_called_once_with('coins/single/history', expected_payload)
    
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_coin_history_with_timestamps(self, mock_make_request, mock_api_key, sample_coin_data):
        ...
        client = LCWClient(api_key=mock_api_key)
        result = client.get_coin_history("BTC", start_timestamp, end_timestamp, currency="EUR")
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_coins_list_default_params(self, mock_make_request, mock_api_key, sample_coin_data):
...
class TestLCWClientExchangeMethods:
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_exchanges_list(self, mock_make_request, mock_api_key, sample_exchange_data):
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_exchanges_list_default_params(self, mock_make_request, mock_api_key, sample_exchange_data):
...
class TestLCWClientMarketMethods:
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_overview_dict_response(self, mock_make_request, mock_api_key, sample_market_data):
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_overview_list_response(self, mock_make_request, mock_api_key, sample_market_data):
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_get_overview_default_currency(self, mock_make_request, mock_api_key, sample_market_data):
...
class TestLCWClientEdgeCases:
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_exchange_methods_with_empty_response(self, mock_make_request, mock_api_key):
    ...
    @patch('src.lcw_fetcher.api.client.LCWClient._make_request')
    def test_special_characters_in_coin_code(self, mock_make_request, mock_api_key, sample_coin_data):
